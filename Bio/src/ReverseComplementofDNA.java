 ...
 * 
 */
public class ReverseComplementofDNA extends javax.swing.JFrame {

    /**
     * Creates new form ReverseComplement
     */
    public ReverseComplementofDNA() {
        initComponents();
        setVisible(true);
    ...
    private void initComponents() {
        ...
        titleLabel.setText("REVERSE COMPLEMENT OF DNA");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReverseComplementofDNA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReverseComplementofDNA().setVisible(true);
            }
        });
    }
